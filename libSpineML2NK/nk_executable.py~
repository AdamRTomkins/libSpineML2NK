...
class Executable(object):
    ...
    def execute(self):
        ...
        ## output the input
        with h5py.File(self.params['input_file']+'.h5', 'w') as f:
    ...
    def initialise_input(self,params,lpu_start,lpu_size):
        ...
        if (itype == smlExperiment.TimeVaryingArrayInputType):
            ...
            self.inputs = nk_utils.ConstantInput(params,lpu_start,lpu_size,time,self.inputs)
