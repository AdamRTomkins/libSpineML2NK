...
class NarxPhotoReceptor(BaseNeuron):
    ...
    def __init__(self, n_dict, output, dt, debug=False, LPU_id=None,component=None):
        ...
        self.debug = debug
        self.LPU_id = LPU_id
        self.component = smlComponent.load('SpineMLComponents/NarxPhotoReceptor.xml') #component.ComponentClass
                         # Link to a copy of the Component Class
                         # Load a local copy 
